...
group = "settingdust.fluid_tick_structure_processor"
    ...
    run fabric@{
        ...
        targets.withType<FabricTarget> {
            ...
            metadata {
                entrypoint("main") {
                    adapter = "kotlin"
                    value = "$group.fabric.FluidTickStructureProcessorFabric::init"
                }

                entrypoint("client") {
                    adapter = "kotlin"
                    value = "$group.fabric.FluidTickStructureProcessorFabric::clientInit"
                }
